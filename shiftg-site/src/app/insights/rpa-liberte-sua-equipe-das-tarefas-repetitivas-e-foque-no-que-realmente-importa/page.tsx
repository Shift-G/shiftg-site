...
const benefits = [
  {
    ...
    description:
      "Cada processo estático é dinheiro sangrando à base de custo-hora por operador. Extirpou as horas, lucrou integralmente.",
    icon: TrendingUp,
  },
  {
    title: "Torque e Eficiência Desenfreada",
    description:
      "Sem cansaço ocular, sem intervalo de descanso, taxa de processamento de dezenas a centenas de tarefas/s em VM clusterizada.",
    icon: Zap,
  },
  {
    title: "Latência ou Erro: Zero",
    description:
      "O Copy/Paste humano falha à taxa de exaustão, custando milhões em devoluções. Máquinas em pipeline não faturam errado o CTe.",
    icon: Target,
  },
  {
    title: "Alívio C-Level e Escala Tática",
    description:
      "Ao demitir o funcionário virtual (o humano que só preenche planilhas), você o aloca estrategicamente para desenhar novas engrenagens nas Key-Accounts vitais.",
    icon: Users,
  },
  {
    title: "Malha de Logs Intransponível (Compliance)",
    description:
      "RPA não comete desvios éticos em sistemas bancários, emitindo footprints em cada cursor num Datawarehouse perfeitamente rastreável.",
    icon: Shield,
  },
];
          ...
          <Frame wide>
            ...
            >
              ...
              <Text fontSize="lg" color="fg.muted" lineHeight={1.8}>
                Deixe máquinas conduzirem tarefas de máquinas. Alinhe robôs
                automatizados em suas interfaces corporativas e expulse os
          ...
          <Frame>
            <VStack maxW="800px" mx="auto" align="stretch" gap={10}>
              <Text fontSize="lg" color="fg" lineHeight={1.8} fontWeight={500}>
                Copiar strings de um PDF e colá-las no ERP base. Puxar as
                estatísticas por ID semanal em portais desconexos, aglutiná-las,
                rodar uma macro e encaminhá-las via intranet. Todas as rotinas
                que não dependem da criatividade humana são lixo metabólico da
                organização moderna, drenando performance e o P&L inteiro em
                silêncio.
              </Text>

              <Text fontSize="md" color="fg.muted" lineHeight={1.8}>
                E se sua equipe executiva pudesse apenas liderar? Um operador
                digital (bot RPA embarcado em Virtual Machine) jamais se
                dispersa. Ele mapeia os pixels e coletores de interface do seu
                sistema velho e traciona 24hrs de produtividade letal entregando
                taxas zero-error nas tabelas finais.
              </Text>
              ...
              >
                ...
                <Text
                  ...
                  lineHeight={1.6}
                >
                  O cenário RPA no B2B atual ignora processos artesanais e vai
                  direto à fonte. Você aponta uma regra, nós alocamos uma
                  instância Serverless de RPA, e o processo ocorre
                  assincronamente (Invisível aos seus olhos) a milissegundos.
                </Text>
              </Box>
              ...
              <Box pt={8}>
                ...
                <Text fontSize="md" color="fg.muted" lineHeight={1.8} mb={6}>
                  Com o framework da Shift+G operante, não precisamos de API
                  abertas dos portais antigos (embora favoreçam). Nossos
                  extratores dissecam elementos renderizados de tela e executam
                  a regra corporativa:
                </Text>
              ...
              <Box pt={10} borderTop="1px solid" borderColor="blackAlpha.200">
                ...
                <Text fontSize="md" color="fg.muted" lineHeight={1.8} mb={8}>
                  Sistemas convencionais de automação travam perante a
                  irregularidade de uma Invoice (Nota de Insumos extrativista)
                  manchada em PDF. O diferencial SHIFT+G é arquitetar a mescla
                  implacável de RPA e I.A generativa (Vision):
                </Text>
                  ...
                  {useCases.map((useCase) => (
                    ...
                    >
                      <HStack gap={6} mb={6} align="flex-start">
                        ...
                        <Text fontSize="xl" fontWeight={800} flex={1}>
                          {useCase.title}
                        </Text>
                      </HStack>
              ...
              >
                <Text fontSize="2xl" fontWeight={800} mb={4}>
                  Substitua Imediatamente o Trabalho Arcaico.
                </Text>
                <Text
                  fontSize="md"
                  ...
                  lineHeight={1.6}
                >
                  Nós calculamos onde as máquinas podem drenar os custos inúteis
                  com exatidão matemática. Despache as burocracias para
                  pipelines RPA.
                </Text>
