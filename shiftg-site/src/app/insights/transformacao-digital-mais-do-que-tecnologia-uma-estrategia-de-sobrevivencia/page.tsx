          ...
          <Frame wide>
            ...
            >
              ...
              <Text fontSize="lg" color="fg.muted" lineHeight={1.8}>
                Mapeamento sobre os 4 Pilares Inquebráveis: não se baseie apenas
                na pilha técnica (Stack), reconstrua a logística corporativa do
          ...
          <Frame>
            <VStack maxW="800px" mx="auto" align="stretch" gap={10}>
              <Text fontSize="lg" color="fg" lineHeight={1.8} fontWeight={500}>
                A expressão 'Transformação Digital' soa diluída repetida à
                exaustão por consultorias padrão. Quando aplicamos este modelo
                mental na Shift+G não queremos forçar assinaturas mensais de
                dezenas de SaaS (Software As a Service) coloridos e sim
                desmontar o veículo organizacional com a engenharia reversa mais
                pura e refazê-lo.
              </Text>

              <Text fontSize="md" color="fg.muted" lineHeight={1.8}>
                Compram-se módulos complexos para resolver fluxos internos
                simples — adicionando ruídos impagáveis e redundâncias mortais à
                operação. Transformação não é digitalização compulsiva do lixo
                prévio de dados, é a destruição da engrenagem enferrujada e
                substituição desta por pipelines invisíveis e autoescaláveis.
              </Text>
              ...
              >
                ...
                <Text
                  ...
                  lineHeight={1.6}
                >
                  Evitamos a falácia dos pacotes "ágil" pré-feitos. Operações
                  verdadeiramente perigosas no mercado B2B constroem soluções
                  robustas dedicadas ao estresse — desenhando processos com IA
                  para matar gargalos em 4 macros.
                </Text>
              </Box>
              ...
              <Box pt={10} borderTop="1px solid" borderColor="blackAlpha.200">
                ...
                <Text fontSize="md" color="fg.muted" lineHeight={1.8} mb={8}>
                  Operar num nível militar nos projetos não significa abandonar
                  a intuição humana, e sim livrá-la da mediocridade do data
                  entry repetitivo entregando-a focos hiper-analíticos
                  (estratégia global B2B, inovação pura, alianças pesadas).
                </Text>
              ...
              >
                <Text fontSize="2xl" fontWeight={800} mb={4}>
                  Cortes Precisos na Jornada Corporativa
                </Text>
                <Text
                  fontSize="md"
                  ...
                  lineHeight={1.6}
                >
                  Evite ser mais uma corporação esmagada sob milhões do P&L
                  estocados em ineficiência burocrática por recusa à base
                  tecnológica de nova esteira.
                </Text>
