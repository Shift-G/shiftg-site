...
export const metadata = pageMetadata(
  "Software sob medida em União da Vitória",
  "Desenvolvimento de software, integração de sistemas e automação para empresas em União da Vitória, Porto União e região, com atendimento também em Curitiba.",
  "/fabrica-de-software",
);
...
const problems = [
  {
    ...
    description:
      "Tarefas repetitivas que consomem tempo precioso e geram gargalos na sua equipe.",
    icon: <Cog size={20} />,
    tag: "LENTIDÃO",
  },
  {
    ...
    description:
      "Dados importantes espalhados por sistemas que não conversam, impedindo a visão unificada.",
  ...
  },
  {
    ...
    description:
      "Dependência de fornecedores engessados para gerar um simples relatório ou customização.",
    icon: <Lock size={20} />,
    tag: "DEPENDÊNCIA",
  },
  {
    ...
    description:
      "Sua operação tendo que se adaptar a ferramentas genéricas, e não o oposto.",
    icon: <Wrench size={20} />,
    tag: "FRICÇÃO",
  },
];
...
const teamSolutions = [
  {
    ...
    description:
      "Plataformas internas para RH, gestão de metas e aprovações, mapeadas para sua cultura.",
    icon: <Building2 size={24} />,
  },
  {
    title: "Automação de Workflows",
    description:
      "Scripts e motores lógicos para conciliação de dados, tarefas de back-office e processos críticos.",
    icon: <Zap size={24} />,
  },
  {
    title: "Portais Seguros",
    description:
      "Ambientes isolados (B2B/B2C) com autenticação, para colaboradores, fornecedores e autoatendimento.",
    icon: <Users size={24} />,
  },
];
...
const managementSolutions = [
  {
    ...
    description:
      "Consolidação de métricas em tempo real (ERP + CRM + Legacy) para direção precisa.",
    icon: <BarChart3 size={24} />,
  },
  {
    title: "Governança e Compliance",
    description:
      "Sistemas fechados para garantir travas, rastreabilidade de acessos (logs gerais) e auditoria.",
    icon: <Shield size={24} />,
  },
  {
    title: "Orquestração de APIs",
    description:
      "Middlewares seguros que conectam o ERP arcaico ao novo SaaS moderno sem perder dados.",
    icon: <Layers size={24} />,
  },
];
...
const approach = [
  {
    ...
    description:
      "Mergulhamos na sua operação para achar a raiz do gargalo. Definimos escopo e KPIs antes de codar.",
  },
  {
    step: "02",
    title: "UX/UI & Specs",
    description:
      "Prototipagem em alta fidelidade. O software deve requerer treinamento zero de tão óbvio de ser usado.",
  },
  {
    step: "03",
    title: "Dev & Integrações",
    description:
      "Ciclos ágeis de entrega contínua. Você testa funcionalidades reais semana a semana.",
  },
  {
    step: "04",
    title: "Rollout e Sustentação",
    description:
      "O código não morre no deploy. Mantemos, escalamos e evoluímos as ferramentas com a sua empresa.",
  },
];
  ...
  return (
    <Page>
      ...
      <VStack gap={0} w="full" as="main" align="stretch">
            ...
            >
              <Box>
                ...
                <Text fontSize="md" color="fg.muted" lineHeight={1.8}>
                  A realidade dura: softwares de "prateleira" te obrigam a
                  modificar os processos da empresa para se adequar a eles. Nós
                  fazemos a tecnologia nascer moldada ao seu fluxo.
                </Text>
              </Box>
        ...
        <Box as="section" bg="blue.solid" color="white">
          <Frame>
              ...
              >
                <VStack align="flex-start" gap={6} maxW="500px">
                  ...
                  <Text fontSize="md" color="whiteAlpha.800" lineHeight={1.8}>
                    Transformamos suas ideias corporativas ou intenção
                    mercadológica em um Data-Produto real. De pagamentos
                    recorrentes a ambientes isolados na nuvem, construímos a
                    base para escalar.
                  </Text>
              ...
              >
                <VStack align="flex-start" gap={6} maxW="500px">
                  ...
                  <Text fontSize="md" color="whiteAlpha.800" lineHeight={1.8}>
                    ...
                    um template genérico. Criamos portais corporativos
                    complexos, e-commerce deep-integrated e vitrines B2B que
                    impõem autoridade.
                  </Text>
                  ...
                  <Box mt={4}>
                    <Link href="/contato" passHref>
                      <HStack
                        ...
                        transition="all 0.2s"
                      >
                        <Text as="span">CONVERSAR SOBRE WEB</Text>
                        <ArrowRight size={16} />
                      </HStack>
                    </Link>
                  </Box>
            ...
            >
              ...
              >
                ...
                <Text fontSize="md" color="fg.muted" mt={6} lineHeight={1.8}>
                  Não somos apenas construtores de código genérico. Nossa base
                  técnica surgiu desenhando softwares ultra-complexos de AI e
                  Analytis. Cada linha é escrita focada em ROI, estabilidade e
                  inteligência de dados nativa.
                </Text>

                <HStack gap={8} mt={10}>
                  <VStack align="start" gap={1}>
                    <Text fontSize="3xl" fontWeight={800} color="blue.solid">
                      Cloud
                    </Text>
