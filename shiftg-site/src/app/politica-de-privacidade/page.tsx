...
const policySections = [
  {
    ...
    content:
      "Nossas interfaces públicas não rastejam seu comportamento. A Shift+G não emprega cookies de marketing ou scripts analíticos invasivos de terceiros neste domínio. O rastreamento de IP é restrito a matrizes de segurança de borda contra ataques DDoS, deletados após 24 horas. Nenhum dado de sessão é vendido.",
  },
  {
    id: "SEC-02",
    title: "Dados de Onboarding",
    content:
      "Quando uma corporação solicita auditoria ou software, os dados fornecidos (CNPJ, DREs sumários, organogramas locais) são imediatamente movidos para nossos cofres na camada Serverless AWS/GCP, criptografados at-rest. Apenas engenheiros sêniores atrelados ao seu cluster possuem chaves de decriptação temporária.",
  },
  {
    id: "SEC-03",
    title: "Base Legal de Tratamento",
    content:
      "Operamos estritamente sob a Lei 13.709/18 (LGPD). Seus dados táticos só existem em nossos servidores sob a égide de 'Execução Contratual' ou 'Legítimo Interesse' quando você deliberadamente requisita inteligência artificial em cima deles.",
  },
  {
    id: "SEC-04",
    title: "Isolamento de Máquinas (LLM Privacy)",
    content:
      "Nenhum dado estratégico da sua empresa ou de seus clientes finais submetidos aos nossos sistemas de I.A. será utilizado para treinar modelos base públicos (OpenAI, Anthropic). A Shift+G garante Zero-Data-Retention Agreements com todos os vendors.",
  },
  {
    id: "SEC-05",
          ...
          <Frame wide>
            ...
            >
              ...
              <Text fontSize="lg" color="fg.muted" lineHeight={1.8}>
                Você não é o produto. O manifesto de privacidade da Shift+G
                opera como uma fortaleza corporativa: dados entram encriptados,
                insights saem precisos, e sua infraestrutura permanece
                imaculada.
              </Text>
            </VStack>
          </Frame>
            ...
            <VStack maxW="800px" mx="auto" align="stretch" gap={10}>
              ...
              >
                ...
                <Text
                  ...
                  lineHeight={1.6}
                >
                  O vazamento de um dado corporativo não é apenas um deslize, é
                  o colapso do P&L. Nossa Stack não negocia a integridade da sua
                  informação. Este documento rege os termos inquebráveis de como
                  lidamos com a sua matriz de dados.
                </Text>
              </Box>
